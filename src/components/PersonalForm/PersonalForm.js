...
const PersonalForm = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      setData({ ...data, firstName: getValues().firstName, lastName: getValues().lastName, email: getValues().email, phoneNumber: getValues().phoneNumber })
  ...
  return (
    <div className={classes.left}>
      ...
      <form className={classes.form} onSubmit={handleSubmit(submit)}>
        ...
        <FormButton previous={true} forwardref={forward} backwardref={backward} />
      </form>
    </div >
  )
}
