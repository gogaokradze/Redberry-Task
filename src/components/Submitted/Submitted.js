...
const Submitted = ({ data, index, skills }) => {
  ...
  return (
    <div className={classes.main}>
      <button
        className={show ? classes.button1 : classes.button}
        onClick={() => setShow(prevValue => !prevValue)}
      >
        <div className={classes.buttondiv}>
          <span>{index + 1}</span>
          <span className={show ? classes.rotateup : classes.rotatedown}>
            {' '}
            &gt;
          </span>
        </div>
          ...
          <div className={classes.display}>
            ...
            <div className={classes.covid}>
              ...
              <div className={classes.radio}>
                ...
                <label>
                  <input
                    type='radio'
                    checked={
                      data.work_preference === 'from_office' ? true : false
                    }
                    disabled
                  />
                  From Sairme Office
                ...
                <label>
                  <input
                    type='radio'
                    checked={
                      data.work_preference === 'from_home' ? true : false
                    }
                    disabled
                  />
                  From Home
                ...
                <label>
                  <input
                    type='radio'
                    checked={data.work_preference === 'hybrid' ? true : false}
                    disabled
                  />
                  Hybrid
                </label>
              ...
              <div className={classes.radio}>
                ...
                <label htmlFor='yes'>
                  <input type='radio' checked={data.had_covid} disabled />
                  Yes
                </label>
                <label htmlFor='no'>
                  <input type='radio' checked={!data.had_covid} disabled />
              ...
              {data.had_covid && (
                <div>
                  <DatePicker
                    ...
                    placeholderText={data.had_covid_at}
                    disabled
                  />
              ...
              <div className={classes.radio}>
                ...
                <label>
                  <input type='radio' checked={data.vaccinated} disabled />
                  Yes
                </label>
                <label>
                  <input type='radio' checked={!data.vaccinated} disabled />
              ...
              {data.vaccinated && (
                <div>
                  <DatePicker
                    className={classes.date}
                    placeholderText={data.vaccinated_at}
                    disabled
                  />
                  <Calendar className={classes.calendar} />
                </div>
