...
const Covid = () => {
  ...
  useEffect(() => {
    return () => {
      setData({
        ...data,
        work_preferance: getValues().work_preferance,
        had_covid: getValues().had_covid,
        had_covid_at: startDate2,
  ...
  const covidInfo = submitedData => {
    setData({
      ...data,
      work_preferance: submitedData.work_preferance,
      had_covid: submitedData.had_covid,
      had_covid_at: startDate2,
      vaccinated: submitedData.vaccinated,
      vaccinated_at: startDate,
    })
